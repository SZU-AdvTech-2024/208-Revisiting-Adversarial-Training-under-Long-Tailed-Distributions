...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default=r'G:\task\10-AT-BSL-main\model-wrn-cifar100-aua\epoch76.pt')
    ...
    if args.dataset == 'cifar10':
        ...
        item = datasets.CIFAR100(root='./datasets/data/cifar-100-python', train=False, transform=transform_chain, download=True)
        test_loader = data.DataLoader(item, batch_size=args.batch_size, shuffle=False, num_workers=0)
